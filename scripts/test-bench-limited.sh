...
for workload in single_block_update bulk_random_updates full_chunk_relight bulk_writes_no_read; do
    echo "[bench-limited] $workload x 100"
    R=$("$PMH" bench "$workload" 100 42)
